      ...
      <div class="header">
          ...
          <div class="header_center">
            <nav class="menu_wrapper">
              <ul>
                <li style="background-color: black;"><a style="color: #f16521;" href="restaurant_filter.php">Restaurante</a></li>
                <li><a href="coffee_filter.php">Café</a></li>
