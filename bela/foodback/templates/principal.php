            ...
            <div id="popup_registar">
              <div class="popup_container animate">
                ...
                <div class="dados">
                  ...
                  <input type="text" placeholder="Nome" name="nome" value ="<?$name?>" required>

                  <label><b>Email</b></label>
                  <input type="text" placeholder="Email" name="email" value ="<?$email?>" required>

                  <label><b>Codigo Postal</b></label>
                  <input type="text" placeholder="Codigo Postal" name="cod_postal" value ="<?$zipcode?>" required>
                  ...
                  <input type="password" placeholder="Palavra-Passe" name="password" value ="<?$password?>" required>
