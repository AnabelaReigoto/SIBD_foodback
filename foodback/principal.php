...
<html>
  <?php
    include ('/usr/users2/mieec2014/up201404125/public_html/foodback/config/init.php'); //MUDAR
    include ('/usr/users2/mieec2014/up201404125/public_html/foodback/database/users.php'); //MUDAR
  ?>
  <head>
