...
<html>
  <head>
    ...
    <link rel="stylesheet" href="style_estab.css">
    <meta charset="UTF-8">
    ...
    <div class="wrapper">
      ...
      <div class="header">
        <div class="header_top">
          <div class="login">
            <!-- Registar -->
            <div class="registar">
              <a href="javascript:void(0)" onclick="toggle_visibility('popup_registar')">Registar</a>
            </div>
            ...
            <div id="popup_registar">
              <div class="popup_container animate">
                <div class="window">
                  <span class="cross" href="javascript:void(0)" onclick="toggle_visibility('popup_registar')">&times;</span>
                  <h3>Criar Conta</h3>
                </div>
                <div class="dados">
                  ...
                  <button class="enterbtn" type="submit" href="javascript:void(0)" onclick="toggle_visibility('popup_registar')">Registar</button>
                </div>
              </div>
            </div>
            ...
            <!-- Entrar -->
            <div class="entrar">
              <a href="javascript:void(0)" onclick="toggle_visibility('popup_entrar')">Entrar</a>
            </div>
            ...
            <div id="popup_entrar">
              <div class="popup_container animate">
                <div class="window">
                  <span class="cross" href="javascript:void(0)" onclick="toggle_visibility('popup_entrar')">&times;</span>
                  <h3>Entrar</h3>
                </div>
                <div class="dados">
                  <label><b>Nome de utilizador</b></label>
                  ...
                  <button class="enterbtn" type="submit" href="javascript:void(0)" onclick="toggle_visibility('popup_entrar')">Entrar</button>
                </div>
                <div class="rodape">
      ...
      <div class="content">
        <div class="content_top">
          ...
          <img src="FOTOS/pizza.jpg" alt="logo">
          <div class="atributos">
            <h2>Informações</h2>
            <div class="info">
              <div class="morada">
            ...
            <div class="menu">
              <div class="slideshow">
                <div class="mySlides fade">
                  ...
                  <img src="FOTOS/img1.jpg" style="width:60%">
                ...
                <div class="mySlides fade">
                  ...
                  <img src="FOTOS/img3.jpg" style="width:60%">
